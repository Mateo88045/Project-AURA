...
/**
 * A content part. `cache_control` marks a prompt-caching breakpoint — for
 * Anthropic models OpenRouter caches everything up to and including this part,
 * so a stable system prompt is only billed at full rate once per ~5 min window.
 */
